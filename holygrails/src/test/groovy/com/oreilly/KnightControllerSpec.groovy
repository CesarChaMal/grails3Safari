...
class KnightControllerSpec extends Specification {
    ...
    void "Test the index action returns the correct model"() {
        given:
        controller.knightService = Mock(KnightService) {
            1 * list(_) >> []
            1 * count() >> 0
        }
    ...
    void "Test the save action with an invalid instance"() {
        given:
        controller.knightService = Mock(KnightService) {
            1 * save(_ as Knight) >> { Knight knight ->
                throw new ValidationException("Invalid instance", knight.errors)
            }
        }
    ...
    void "Test the show action with a valid id"() {
        ...
        model.knight instanceof Knight
    }
