...
<html>
    <head>
        ...
        <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCfjf9Il5PFGctk1DUwXK83Vdvng5M71cg"></script>
        ...
        <div id="list-castle" class="content scaffold-list" role="main">
            ...
            <script type="text/javascript">
                ...
                function drawVisualization() {
                    ...
                    $.getJSON('/holygrails/castle/index.json').done(function (data) {
